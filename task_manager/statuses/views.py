...
from task_manager.mixins import LoginCheckMixin, TemplateContextMixin, DeleteProtectedObjectMixin
...
class StatusCreateView(LoginCheckMixin,
                       SuccessMessageMixin,
                       CreateView):
    model = Status
    fields = ['name']
...
class StatusUpdateView(LoginCheckMixin,
                       SuccessMessageMixin,
                       UpdateView):
    model = Status
    fields = ['name']
